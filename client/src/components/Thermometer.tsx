  ...
  return (
    <div className="flex flex-col items-center justify-center">
      ...
      <div className="relative w-32 h-96 md:w-40 md:h-[480px] mb-8">
        {/* Outer Glow */}
        <div className="absolute inset-0 rounded-full blur-3xl bg-gradient-to-b from-cyan-500/30 to-purple-500/20 animate-pulse-glow" />

        {/* Main Thermometer */}
        <div className="relative w-full h-full glass rounded-3xl overflow-hidden border-2 border-cyan-400/50 shadow-2xl">
          ...
          {/* Score Labels */}
          <div className="absolute left-4 top-4 text-xs font-mono text-cyan-400/60 space-y-2">
            <div className="text-right pr-2">1000</div>
          </div>
          <div className="absolute left-4 bottom-20 text-xs font-mono text-cyan-400/60">
            <div className="text-right pr-2">500</div>
          </div>
          <div className="absolute left-4 bottom-4 text-xs font-mono text-cyan-400/60">
            <div className="text-right pr-2">0</div>
          </div>

          {/* Fill Animation */}
          <div
            className="absolute bottom-0 left-0 right-0 bg-gradient-to-t from-cyan-400 via-purple-500 to-transparent opacity-70 transition-all duration-300 ease-out"
            style={{ height: `${percentage}%` }}
          />

          {/* Liquid Effect */}
          <div
            className="absolute bottom-0 left-0 right-0 bg-gradient-to-t from-cyan-300/40 to-transparent opacity-50"
            style={{ height: `${percentage}%` }}
          />

          {/* Center Indicator */}
          <div className="absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 w-8 h-8 rounded-full bg-gradient-to-br from-cyan-400 to-purple-500 glow-cyan shadow-lg" />
          ...
          <div className="absolute inset-0 flex flex-col items-center justify-center">
            ...
            <div className="text-xs text-cyan-300/80 mt-2 font-mono">SCORE</div>
          </div>
        </div>
      </div>
